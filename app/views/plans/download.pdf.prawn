...
pdf.move_down(10)
pdf.text "Share the online version of this plan (in read-only form) using <u>#{link_to plan_url(@plan.private_guid), plan_url(@plan.private_guid)}</u>", :inline_format => true if @plan.public_guid
